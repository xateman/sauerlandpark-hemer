  ...
  while (have_posts()) : the_post();
    ...
    <div class="park-map-wrapper">
      <div class="map-switcher">
        <a href="<?php the_permalink($post->post_parent); ?>" title="<?php _e('Übersichtsplan anzeigen', LOCAL); ?>"><span class="fad fa-layer-group"></span></a>
      </div>
    ...
    <main class="<?php echo element_location(); ?> has-header-image">
      <div class="content-wrap">
        <div class="post-content">
          <h1><?php the_title(); ?></h1>
          <div class="location-groups grid-m-3">
            <?php
            $args = [
              'type'         => 'poi',
              'child_of'     => 0,
